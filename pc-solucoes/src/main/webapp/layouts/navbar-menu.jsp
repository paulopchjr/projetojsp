	...
	<div class="pcoded-inner-navbar main-menu">
		<div class="">
			<div class="main-menu-header">
				...
				<c:if test="${imgUser !=null && imgUser !=''}">
					<img class="img-80 img-radius" src="${imgUser}"
					...
					<c:if test="${perfil == 'ADMIN'}">
						<li class="">
							<a	href="<%=request.getContextPath()%>/ServletUsuarioController?acao=listarusuarios" class="waves-effect waves-dark"> 
								...
								<span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Cad.Usuários</span> 
		...
		<div class="pcoded-navigation-label" data-i18n="nav.category.forms">Relátorio</div>
		<ul class="pcoded-item pcoded-left-item">
			<li>
			 ...
			 <li>
			 		<a href="<%=request.getContextPath()%>/principal/relatoriousuariografico.jsp" class="waves-effect waves-dark">
                                      <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                      <span class="pcoded-mtext" data-i18n="nav.form-components.main">Rel.Gráfico</span>
                                      <span class="pcoded-mcaret"></span>
                   </a>
            </li>
		</ul>
